...
namespace kuhn_munkres {
    ...
    private:
         ...
         */
        static Vec2f padMatrix(Vec2f const &matrix, float padValue = 0.0);
         ...
         */
        static Vec2i makeMatrix(int const &n, int const &val);
         ...
         */
        [[nodiscard]] float findSmallest() const;
         ...
         */
        [[nodiscard]] pair<int, int> findAZero(int i0 = 0, int j0 = 0) const;
         ...
         * @return column index.
         */
        [[nodiscard]] int findStarInRow(int row) const;
         ...
         * @return row index.
         */
        [[nodiscard]] int findStarInCol(int col) const;
         ...
         * @return column index
         */
        [[nodiscard]] int findPrimeInRow(int row) const;

        void convertPath(Vec2i const &_path, int count);
